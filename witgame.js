...
$pyjs.loaded_modules['witgame'] = function (__mod_name__) {
	...
	$m['IntroPage'] = (function(){
		...
		$cls_definition['DiceInstance'] = 0;
		$cls_definition['VarTempScore'] = 0;
		$cls_definition['VarTotScore'] = $p['list']([]);
		$cls_definition['CountTurn'] = 1;
		$cls_definition['aaa'] = 9;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('StillImage', function() {
			...
			self.image = $m['Image']($p['__op_add']($add19=$p['__op_add']($add17=$p['__op_add']($add15=$p['getattr'](self, 'DummyUrl'),$add16='images/'),$add18=$p['str']($p['getattr'](self, 'DiceInstance'))),$add20='.png'));
			...
			$m['RootPanel']()['add']($p['getattr'](self, 'DPanel'));
			self['timer']['cancel']();
			if ($p['bool'](!$p['op_eq']($p['getattr'](self, 'DiceInstance'), 1))) {
				self['TempBoard']['setText'](1, 1, $p['__op_add']($add21=$p['getattr'](self, 'DiceInstance'),$add22=$p['float_int'](self['TempBoard']['getText'](1, 1))));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('RollButtonPressed', function() {
			...
			self.DiceInstance = $m['random']['randint'](1, 6);
			self['DPanel']['remove']($p['getattr'](self, 'image'), $p['getattr']($m['DockPanel'], 'CENTER'));
